    ...
    <>
      ...
      <div className="mt-32 mb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 px-4">
          ...
          <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-white/20 dark:border-white/10 transition-transform hover:translate-y-[-5px]">
