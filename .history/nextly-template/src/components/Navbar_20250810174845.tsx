                      ...
                      <div className="absolute left-0 z-50 hidden pt-4 group-hover:block w-[600px]">
                        <div className="bg-white dark:bg-gray-800 shadow-lg rounded-md py-4 grid grid-cols-2 gap-4 max-h-[80vh] overflow-y-auto">
                          ...
                          >
                            <Link
                              href={subItem.href}
                              className="flex items-center text-gray-800 dark:text-gray-200 hover:text-indigo-500"
                              onClick={(e) => e.stopPropagation()}
                            >
                              <svg
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">{subItem.description}</p>
                          </div>
                            </Link>
                          ))}
                        </div>
