        ...
        <section id="kundenbewertungen" className="py-16">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
            <div className="p-8 md:p-12">
              <h2 className="text-4xl font-bold mb-10 uppercase tracking-wide">KUNDENBEWERTUNGEN</h2>
      ...
      <section className="relative py-24">
        ...
        <Container className="relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl font-bold mb-6 text-white drop-shadow-lg">WERDEN SIE UNSER NÄCHSTES ERFOLGSPROJEKT</h2>
            <p className="text-xl mb-8 text-gray-100 drop-shadow-md">
              Überzeugen Sie sich selbst von unserer Qualität und Professionalität. Kontaktieren Sie uns noch heute für ein unverbindliches Angebot.
            </p>
