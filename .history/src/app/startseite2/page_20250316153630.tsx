    ...
    <>
      ...
      <Container>
        ...
        <div className="py-16">
          ...
          <ImageSlider images={ [...referenceImages, { src: "/img/flux/referenz-mehrfamilienhaus1.webp", alt: "Referenz Mehrfamilienhaus 1" }, { src: "/img/flux/referenz-mehrfamilienhaus2.webp", alt: "Referenz Mehrfamilienhaus 2" }] } width={800} height={600} />
        </div>
