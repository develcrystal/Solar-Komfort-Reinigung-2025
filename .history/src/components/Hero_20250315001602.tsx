...
import heroImg from "../../public/img/flux/quer_Vorher-Nachher Dachreinigung.webp";
        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Solar Komfort GmbH - Die Zukunft auf deinem Dach
            </h1>
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex flex-wrap justify-center gap-5 mt-10 md:justify-around">
            <div className="pt-2 text-gray-400 dark:text-gray-400">
              <p className="text-lg font-bold text-center">Dachreinigung</p>
            </div>
            <div className="pt-2 text-gray-400 dark:text-gray-400">
              <p className="text-lg font-bold text-center">Dachimprägnierung</p>
            </div>
            <div className="pt-2 text-gray-400 dark:text-gray-400">
              <p className="text-lg font-bold text-center">Dachbeschichtung</p>
            </div>
            <div className="pt-2 text-gray-400 dark:text-gray-400">
              <p className="text-lg font-bold text-center">Dachrinnenreinigung</p>
            </div>
            <div className="pt-2 text-gray-400 dark:text-gray-400">
              <p className="text-lg font-bold text-center">Pflasterreinigung</p>
            </div>
            <div className="pt-2 text-gray-400 dark:text-gray-400">
              <p className="text-lg font-bold text-center">Fassadenreinigung</p>
            </div>
          </div>
        </div>
      </Container>
