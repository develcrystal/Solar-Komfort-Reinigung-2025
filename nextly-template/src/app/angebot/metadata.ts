export const metadata = {
  ...
  description: "Erfahren Sie mehr über unser Angebot an professionellen Reinigungs- und Serviceleistungen.",
  keywords: "Angebot, Reinigungsservice, Gebäudereinigung, Komfort Gebäudeservice24",
  openGraph: {
    title: "Angebot – Komfort Gebäudeservice24",
