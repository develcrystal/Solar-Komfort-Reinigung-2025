        ...
        <div className="bg-gray-50 dark:bg-gray-900 py-16 sm:py-20 md:py-24">
          <Section id="galerie">
            <div className="max-w-4xl mx-auto text-center mb-16">
              ...
              <div className="w-20 h-1 bg-blue-600 mx-auto mb-8"></div>
              <p className="text-lg text-gray-600 dark:text-gray-300">
                Sehen Sie die schönen Transformationen unserer Gartenpflege-Projekte. Gepflegte Gärten, zufriedene Kunden.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                {
                  src: "/img/kundenbilder/Gartenpflege (1).webp",
                  alt: "Gartenpflege vorher nachher - Gepflegter Garten mit gesundem Rasen und geschnittenen Hecken",
                  label: "Komplette Gartenpflege"
                },
                {
                  src: "/img/kundenbilder/Gartenpflege.webp",
                  alt: "Professionelle Gartenpflege - Rasenmähen, Heckenschnitt und Beetpflege durchgeführt",
                  label: "Regelmäßige Wartung"
                },
                {
                  src: "/img/kundenbilder/Haus.webp",
                  alt: "Gartenpflege Team - Professionelle Fachkräfte bei der Außenanlagenpflege mit modernem Equipment",
