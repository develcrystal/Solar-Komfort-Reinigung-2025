  ...
  return (
    <>
      ...
      <div className="relative h-[50vh] sm:h-[55vh] md:h-[60vh] min-h-[350px] sm:min-h-[400px] w-full">
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Hotellerie & Gastronomie - Spezialisierte Reinigung für Hotels und Restaurants"
            fill
        ...
        <Container className="relative z-10 h-full flex items-center">
          <div className="max-w-2xl sm:max-w-3xl">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white mb-4 sm:mb-6 md:mb-8 drop-shadow-md">
              Spezialisierte Reinigung für Hotels, Restaurants und gastronomische Betriebe.
            </p>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-gray-600 dark:text-gray-300">
                <li>• Hotelzimmer-Reinigung</li>
                <li>• Küchen- und Restaurantbereiche</li>
                <li>• Lobby und öffentliche Bereiche</li>
                <li>• Sanitäranlagen hygienisch</li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-600 dark:text-gray-300">
                <li>✓ Zufriedene Gäste</li>
                <li>✓ Hygiene-Standards erfüllt</li>
                <li>✓ Schnelle Zimmer-Wechsel</li>
      ...
      <CtaSection
        ...
        backgroundAlt="Kontaktieren Sie uns für Hotellerie & Gastronomie"
        title="Bereit für zufriedene Gäste?"
