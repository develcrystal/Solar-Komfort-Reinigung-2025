      ...
      <div className="relative h-[50vh] sm:h-[55vh] md:h-[60vh] min-h-[350px] sm:min-h-[400px] w-full">
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Krankenhausreinigung - Hygienische Reinigung medizinischer Einrichtungen"
            fill
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-gray-600 dark:text-gray-300">
                <li>• Desinfizierende Reinigung</li>
                <li>• Patientenzimmer und OP-Bereiche</li>
                <li>• Wartezimmer und Flure</li>
                <li>• Spezielle Hygieneverfahren</li>
                <li>• Medizinische Standards erfüllt</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Ihre Vorteile</h3>
              <ul className="space-y-3 text-gray-600 dark:text-gray-300">
                <li>✓ Hygienische Sicherheit</li>
                <li>✓ Geschulte Reinigungskräfte</li>
                <li>✓ Medizinische Standards</li>
                <li>✓ Desinfektions-Protokolle</li>
