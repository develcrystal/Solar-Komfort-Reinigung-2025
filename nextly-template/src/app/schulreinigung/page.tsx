  ...
  return (
    <>
      ...
      <div className="relative h-[50vh] sm:h-[55vh] md:h-[60vh] min-h-[350px] sm:min-h-[400px] w-full">
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Schul- & Kindergartenreinigung - Hygienische Reinigung für Bildungseinrichtungen"
            fill
      ...
      <div className="bg-white dark:bg-gray-900 py-8 sm:py-12 md:py-16 lg:py-20">
        <Container>
          <SectionTitle
            ...
            title="Schul- & Kindergartenreinigung"
          >
            Hygienische Reinigung für Bildungseinrichtungen und Betreuungsstätten.
          </SectionTitle>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3 text-gray-600 dark:text-gray-300">
                <li>• Klassenzimmer und Gruppenräume</li>
                <li>• Sanitäranlagen kindergerecht</li>
                <li>• Flure und Eingangsbereiche</li>
                <li>• Sporthallen und Außenanlagen</li>
                <li>• Desinfektion bei Bedarf</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Ihre Vorteile</h3>
              <ul className="space-y-3 text-gray-600 dark:text-gray-300">
                <li>✓ Gesunde Lernumgebung</li>
                <li>✓ Kindersichere Reinigungsmittel</li>
                <li>✓ Flexible Arbeitszeiten</li>
                <li>✓ Erfahrene Reinigungskräfte</li>
                <li>✓ Hygiene-Standards erfüllt</li>
              </ul>
            </div>
          </div>
        </Container>
      ...
      <CtaSection
        ...
        title="Bereit für saubere Bildungseinrichtungen?"
