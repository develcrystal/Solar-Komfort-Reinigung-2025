              ...
              <div>
                <div className="bg-gray-50 p-8 rounded-xl">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="mt-8">
                      <h3 className="text-xl font-bold text-gray-900 mb-4">Unsere Garantien</h3>
                      <div className="space-y-4">
                        <div className="bg-blue-50 p-4 rounded-lg">
                          <h4 className="font-semibold text-blue-800 mb-2">Termintreue-Garantie</h4>
                          <p className="text-sm text-blue-700">
                            Vereinbarte Reinigungstermine werden zu 100% eingehalten oder Sie erhalten 50% Rabatt auf den Folgeauftrag.
                          </p>
                        </div>
                        <div className="bg-green-50 p-4 rounded-lg">
                          <h4 className="font-semibold text-green-800 mb-2">Qualitäts-Garantie</h4>
                          <p className="text-sm text-green-700">
                            Bei Qualitätsmängeln wird die Reinigung innerhalb von 24h kostenfrei wiederholt.
                          </p>
                        </div>
                        <div className="bg-purple-50 p-4 rounded-lg">
                          <h4 className="font-semibold text-purple-800 mb-2">Sicherheits-Garantie</h4>
                          <p className="text-sm text-purple-700">
                            Alle Mitarbeiter sind SCC-zertifiziert und in Erster Hilfe ausgebildet.
                          </p>
                        </div>
                      </div>
                    </div>
