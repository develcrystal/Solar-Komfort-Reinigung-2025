...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://komfort-gebaeudeservice24.de/img/flux/winterdienst-prozess.webp",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Winterdienst - HK Komfort Facility & Gebäudeservice GmbH",
    description: "Professioneller Winterdienst in Darmstadt und Umgebung. Räumen & Streuen nach Ortssatzung. Maschinenpark & 24/7-Rufbereitschaft.",
    images: ["https://komfort-gebaeudeservice24.de/img/flux/winterdienst-prozess.webp"]
  },
  alternates: {
    ...
    <div className="bg-gray-50 dark:bg-gray-900">
      ...
      <div className="relative h-[50vh] min-h-[400px] w-full">
        <div className="absolute inset-0 z-0">
          <Image 
            src="/img/flux/winterdienst-prozess.webp"
